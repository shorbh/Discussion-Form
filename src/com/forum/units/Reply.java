...
public class Reply extends AbstractEntity {
	...
	public void autoGenerateId() {
		...
		// setId method in the AbstractEntity class 
	...
	public void setMessage(String message) {
		// set the instance variable message to the
	...
	public void setUser(User user) {
		// set the instance variable user to the user variable
	...
	public Question getQuestion() {
		// set the instance variable question
	...
	public void setQuestion(Question question) {
		// set the instance variable question to the question variable
		// that is passed into this method
