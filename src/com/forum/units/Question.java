...
public class Question extends AbstractEntity {
	...
	public void autoGenerateId() {
		...
		// setId method and pass in lastEntry as the method variable;
	...
	public void setTitle(String title) {
		// the instance variable title to the parameter variable title
                this.title = title;
	}
	...
	public String getMessage() {
		// return the instance variable message of this question
                return message;
	}
	...
	public void setMessage(String message) {
		// the instance variable message to the parameter variable message
	 ...
	 */
	public User getUser() {
		// return the instance variable user of this question
                return user;
	}
	...
	public void setUser(User user) {
		// the instance variable user to the parameter variable user
                this.user = user;
	}
	...
	public int getUpvoteCount() {
		// return the instance variable upvoteCount
